...
@JsonSubTypes({
        @JsonSubTypes.Type(value = QuestionnaireAnswers.class, name = "cz.cyberrange.platform.events.adaptive.trainings.QuestionnaireAnswers"),
        @JsonSubTypes.Type(value = CorrectAnswerSubmitted.class, name = "cz.cyberrange.platform.events.adaptive.trainings.CorrectAnswerSubmitted"),
        @JsonSubTypes.Type(value = CorrectPasskeySubmitted.class, name = "cz.cyberrange.platform.events.adaptive.trainings.CorrectPasskeySubmitted"),
        @JsonSubTypes.Type(value = PhaseCompleted.class, name = "cz.cyberrange.platform.events.adaptive.trainings.PhaseCompleted"),
        @JsonSubTypes.Type(value = PhaseStarted.class, name = "cz.cyberrange.platform.events.adaptive.trainings.PhaseStarted"),
        @JsonSubTypes.Type(value = SolutionDisplayed.class, name = "cz.cyberrange.platform.events.adaptive.trainings.SolutionDisplayed"),
        @JsonSubTypes.Type(value = TrainingRunEnded.class, name = "cz.cyberrange.platform.events.adaptive.trainings.TrainingRunEnded"),
        @JsonSubTypes.Type(value = TrainingRunResumed.class, name = "cz.cyberrange.platform.events.adaptive.trainings.TrainingRunResumed"),
        @JsonSubTypes.Type(value = TrainingRunStarted.class, name = "cz.cyberrange.platform.events.adaptive.trainings.TrainingRunStarted"),
        @JsonSubTypes.Type(value = TrainingRunSurrendered.class, name = "cz.cyberrange.platform.events.adaptive.trainings.TrainingRunSurrendered"),
        @JsonSubTypes.Type(value = WrongAnswerSubmitted.class, name = "cz.cyberrange.platform.events.adaptive.trainings.WrongAnswerSubmitted"),
        @JsonSubTypes.Type(value = WrongPasskeySubmitted.class, name = "cz.cyberrange.platform.events.adaptive.trainings.WrongPasskeySubmitted")
})
@SuperBuilder
@Getter
