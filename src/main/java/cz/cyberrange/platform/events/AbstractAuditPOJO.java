...
@JsonSubTypes({
        @JsonSubTypes.Type(value = AssessmentAnswers.class, name = "cz.cyberrange.platform.events.trainings.AssessmentAnswers"),
        @JsonSubTypes.Type(value = CorrectAnswerSubmitted.class, name = "cz.cyberrange.platform.events.trainings.CorrectFlagSubmitted"),
        @JsonSubTypes.Type(value = CorrectAnswerSubmitted.class, name = "cz.cyberrange.platform.events.trainings.CorrectAnswerSubmitted"),
        @JsonSubTypes.Type(value = CorrectPasskeySubmitted.class, name = "cz.cyberrange.platform.events.trainings.CorrectPasskeySubmitted"),
        @JsonSubTypes.Type(value = HintTaken.class, name = "cz.cyberrange.platform.events.trainings.HintTaken"),
        @JsonSubTypes.Type(value = LevelCompleted.class, name = "cz.cyberrange.platform.events.trainings.LevelCompleted"),
        @JsonSubTypes.Type(value = LevelStarted.class, name = "cz.cyberrange.platform.events.trainings.LevelStarted"),
        @JsonSubTypes.Type(value = SolutionDisplayed.class, name = "cz.cyberrange.platform.events.trainings.SolutionDisplayed"),
        @JsonSubTypes.Type(value = TrainingRunEnded.class, name = "cz.cyberrange.platform.events.trainings.TrainingRunEnded"),
        @JsonSubTypes.Type(value = TrainingRunResumed.class, name = "cz.cyberrange.platform.events.trainings.TrainingRunResumed"),
        @JsonSubTypes.Type(value = TrainingRunStarted.class, name = "cz.cyberrange.platform.events.trainings.TrainingRunStarted"),
        @JsonSubTypes.Type(value = TrainingRunSurrendered.class, name = "cz.cyberrange.platform.events.trainings.TrainingRunSurrendered"),
        @JsonSubTypes.Type(value = WrongAnswerSubmitted.class, name = "cz.cyberrange.platform.events.trainings.WrongFlagSubmitted"),
        @JsonSubTypes.Type(value = WrongAnswerSubmitted.class, name = "cz.cyberrange.platform.events.trainings.WrongAnswerSubmitted"),
        @JsonSubTypes.Type(value = WrongPasskeySubmitted.class, name = "cz.cyberrange.platform.events.trainings.WrongPasskeySubmitted")
})
@SuperBuilder
@Getter
